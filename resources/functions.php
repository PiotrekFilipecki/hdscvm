...
function create_post_type() {
    register_post_type( 'hds_background',
      array(
        'labels' => array(
  ...
  wp_localize_script( 'kilo-js', 'kilo_js_vars', array(
...
function misha_filter_function(){
    ...
    if( $query->have_posts() ) :
		...
		while( $query->have_posts() ): $query->the_post();
            echo '<li class="video"><h2>' . $query->post->post_title . '</h2>';
